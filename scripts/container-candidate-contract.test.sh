...
# Contract: 3b83ddeaa421e60005e15d36e946e2f83832bacb
set -euo pipefail
...
grep -qx '# Contract: 3b83ddeaa421e60005e15d36e946e2f83832bacb' "$caller" || fail "caller contract pin differs"
grep -qx '# Contract: 3b83ddeaa421e60005e15d36e946e2f83832bacb' "$validator" || fail "validator contract pin differs"
[ "$(grep -c 'uses: Verjson/.github/.github/workflows/container-candidate.yml@3b83ddeaa421e60005e15d36e946e2f83832bacb' "$caller")" -eq 1 ] || fail "validation does not use the pinned read-only reusable workflow"
[ "$(grep -c 'uses: Verjson/.github/.github/workflows/container-candidate-publish.yml@3b83ddeaa421e60005e15d36e946e2f83832bacb' "$caller")" -eq 1 ] || fail "publication does not use the pinned publication reusable workflow"
[ "$(grep -c 'contract-ref: 3b83ddeaa421e60005e15d36e946e2f83832bacb' "$caller")" -eq 2 ] || fail "caller does not pass the shared pin to both event paths"
...
[ "$(sha256sum "$caller" | cut -d' ' -f1)" = "f5a79431109f7f194db31ca128555c8bf31081a86d6e6f235267b81f3bb290c3" ] || fail "generated caller was edited"
[ "$(sha256sum "$validator" | cut -d' ' -f1)" = "aa06111b3a3d99e1d4e3e9b426c5b39171768fa6e348b28cdad179062d1ab641" ] || fail "generated validator was edited"
